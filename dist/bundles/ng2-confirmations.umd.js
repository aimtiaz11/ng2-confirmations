(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/Subject'), require('@angular/animations')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'rxjs/Subject', '@angular/animations'], factory) :
	(factory((global.ng2Confirmations = global.ng2Confirmations || {}),global.ng.core,global._angular_common,global.rxjs_Subject,global._angular_animations));
}(this, (function (exports,_angular_core,_angular_common,rxjs_Subject,_angular_animations) { 'use strict';

var ConfirmationService = /** @class */ (function () {
    function ConfirmationService() {
        this.confirmation$ = new rxjs_Subject.Subject();
    }
    /**
     * @param {?} title
     * @param {?} message
    ...
    ConfirmationService.prototype.create = function (title, message, override) {
        ...
        var /** @type {?} */ resolve$ = new rxjs_Subject.Subject();
...
var ConfirmationComponent = /** @class */ (function () {
    ...
    ConfirmationComponent.decorators = [
        { type: _angular_core.Component, args: [{
                    ...
                    animations: [
                        _angular_animations.trigger('overlayAn', [
                            _angular_animations.state('void', _angular_animations.style({ opacity: 0 })),
                            _angular_animations.state('leave', _angular_animations.style({ opacity: 0 })),
                            _angular_animations.state('enter', _angular_animations.style({ opacity: 1 })),
                            _angular_animations.transition('void => enter', _angular_animations.animate('400ms cubic-bezier(.25,.8,.25,1)')),
                            _angular_animations.transition('enter => leave', _angular_animations.animate('400ms cubic-bezier(.25,.8,.25,1)'))
                        ]),
                        _angular_animations.trigger('wrapperAn', [
                            _angular_animations.state('void', _angular_animations.style({ opacity: 0, transform: 'scale(0.75, 0.75) translate(0, 0)' })),
                            _angular_animations.state('leave', _angular_animations.style({ opacity: 0, transform: 'scale(0.75, 0.75) translate(0, 0)' })),
                            _angular_animations.state('enter', _angular_animations.style({ opacity: 1, transform: 'scale(1, 1) translate(0, 0)' })),
                            _angular_animations.transition('void => enter', _angular_animations.animate('450ms cubic-bezier(.5, 1.4, .5, 1)')),
                            _angular_animations.transition('enter => leave', _angular_animations.animate('450ms cubic-bezier(.5, 1.4, .5, 1)'))
                        ])
                    ]
                },] },
    ];
...
var ConfirmationsComponent = /** @class */ (function () {
    ...
    ConfirmationsComponent.prototype.ngOnInit = function () {
        ...
        this._listener = this._service.confirmation$.subscribe(function (alert) {
            ...
            if (!alert.close) {
                ...
                var /** @type {?} */ resolvedInputs = _angular_core.ReflectiveInjector.resolve(inputProviders);
                var /** @type {?} */ injector = _angular_core.ReflectiveInjector.fromResolvedProviders(resolvedInputs, _this.compViewContainerRef.parentInjector);
    ...
    ConfirmationsComponent.propDecorators = {
        'compViewContainerRef': [{ type: _angular_core.ViewChild, args: ['comp', { read: _angular_core.ViewContainerRef },] },],
        'defaultSettings': [{ type: _angular_core.Input },],
    };
...
//# sourceMappingURL=ng2-confirmations.umd.js.map
